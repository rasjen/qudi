...
class ConfocalMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        ui_file = os.path.join(this_dir, 'ui_confocalgui_attocube.ui')
...
class ConfocalGui(GUIBase):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.xy_image_orientation = np.array([0, 1, 2], int)
    ...
    def initMainUI(self, e=None):
        ...
        *.ui file and configures the event handling between the modules.
        ...
        arr01 = self._scanning_logic.xy_image[:, :, 2 + self.xy_channel].transpose()
