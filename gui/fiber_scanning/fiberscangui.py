...
class FiberScanMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        ui_file = os.path.join(this_dir, 'ui_fiberscan.ui')
        self._doubleclicked = False

        # Load it
        super(FiberScanMainWindow, self).__init__()
...
class FiberScanSettingDialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        # Load it
        super(FiberScanSettingDialog, self).__init__()
        uic.loadUi(ui_file, self)
...
class FiberScanGui(GUIBase):

    """ Main FiberScan Class for xy and depth scans.
    """
    _modclass = 'FiberScanGui'
    _modtype = 'gui'
    ...
    def initMainUI(self):
        """ Definition, configuration and initialisation of the FiberScan GUI.

        This init connects all the graphic modules, which were created in the
        *.ui file and configures the event handling between the modules.
        Moreover it sets default values.
        """
        self._mw = FiberScanMainWindow()
        ...
        raw_data_depth_line = self._scanning_logic.depth_line[:, 2:4]
        ...
        self.depth_line_plot = pg.PlotDataItem(raw_data_depth_line, pen=pg.mkPen(palette.c1))
        ...
        self._mw.depth_line_ViewWidget.addItem(self.depth_line_plot)
        ...
        self._mw.depth_line_ViewWidget.setLabel('bottom', 'Z position', units='m')
        self._mw.depth_line_ViewWidget.setLabel('left', 'counts per second', units='c/s')
        ...
        self._scanning_logic.signal_depth_line_updated.connect(self.refresh_depth_line)
        ...
        # Connect the 'File' Menu dialog and the Settings window in FiberScan
        # with the methods:
        ...
        self._mw.actionSave_Depth_line_Scan.triggered.connect(self.save_depth_line_scan_data)
    ...
    def initSettingsUI(self):
        ...
        *.ui file and configures the event handling between the modules.
        ...
        self._sd = FiberScanSettingDialog()
...
#        self._mw.actionRotated_depth_scan.setEnabled(True)
    ...
    def _refocus_finished_wrapper(self, caller_tag, optimal_pos):
        ...
        Also, if the refocus was initiated here in FiberScangui then we need to handle the
        "returned" optimal position.
        """
        if caller_tag == 'FiberScangui':
    ...
    def refocus_clicked(self):
        ...
        self.sigStartOptimizer.emit(crosshair_pos, 'FiberScangui')
    ...
    def update_crosshair_position_from_logic(self, tag):
        ...
        FiberScan gui emits, as the GUI elements were already adjusted.
        """
    ...
    def save_xy_scan_data(self):
        ...
        filename = filepath + os.sep + time.strftime('%Y%m%d-%H%M-%S_FiberScan_xy_scan_raw_pixel_image')
    ...
    def small_optimizer_view(self):
        ...
        self._mw.depth_line_scan_dockWidget.hide()
    ...
    #####################################################################
    #        Methods for the zoom functionality of FiberScan GUI         #
    #####################################################################
